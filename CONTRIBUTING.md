...
issue](https://github.com/cisagov/teamserver-packer/issues) in this
...
request](https://github.com/cisagov/teamserver-packer/pulls), you will
...
pyenv virtualenv <python_version_to_use> teamserver-packer
pyenv local teamserver-packer
